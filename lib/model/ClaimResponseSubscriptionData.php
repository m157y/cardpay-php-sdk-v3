...
class ClaimResponseSubscriptionData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimResponseSubscriptionData';
     ...
     * Sets status_to
     *
     * @param string $status_to Requested status of subscription
     *
     * @return $this
     */

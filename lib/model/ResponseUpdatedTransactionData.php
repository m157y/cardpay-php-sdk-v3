...
class ResponseUpdatedTransactionData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseUpdatedTransactionData';
     ...
     * Sets id
     *
     * @param string $id Represents the ID of the modified transaction
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Status of modified or created transaction
     *
     * @return $this
     */
     ...
     * Sets status_to
     *
     * @param string $status_to Requested action (status to be set).  Payment: `COMPLETE` or `REVERSE`.  Refund, payout: `REVERSE`.
     *
     * @return $this
     */
     ...
     * Sets updated
     *
     * @param \DateTime $updated Transaction update date and time in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. Returned only for successful update operations.
     *
     * @return $this
     */
